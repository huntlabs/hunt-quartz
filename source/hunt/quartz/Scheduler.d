 ...
 * 
 * <p>
 * A <code>Scheduler</code> maintains a registry of <code>{@link hunt.quartz.JobDetail}</code>s
 ...
 * via the <code>scheduleJob(JobDetail, Trigger)</code> or <code>addJob(JobDetail, bool)</code>
 * method.
 * </p>
 * 
 * <p>
...
interface Scheduler {
    ...
    /**
     * Add the given <code>{@link hunt.quartz.JobDetail}</code> to the
     ...
     * </p>
     *
     * @see #addJob(JobDetail, bool, bool)
     *
     * @throws SchedulerException
    ...
    /**
     * Trigger the identified <code>{@link hunt.quartz.JobDetail}</code>
     * (execute it now).
     */
    ...
    /**
     * Get the names of all known <code>{@link hunt.quartz.JobDetail}</code>
     * groups.
     */
    List!(string) getJobGroupNames();

    /**
     * Get the keys of all the <code>{@link hunt.quartz.JobDetail}s</code>
     ...
     * JobDetail afterward (e.g. see {@link #addJob(JobDetail, bool)}).
     * </p>
     * 
     */
