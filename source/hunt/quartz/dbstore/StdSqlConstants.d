...
struct StdSqlConstants {
    ...
    enum string SELECT_JOB_EXISTENCE = "SELECT " ~ COL_JOB_NAME
            ~ " FROM " ~ TABLE_PREFIX_SUBST ~ TABLE_JOB_DETAILS ~ " WHERE "
            ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
            ~ " AND " ~ COL_JOB_NAME
            ~ " = ? AND " ~ COL_JOB_GROUP ~ " = ?";

    enum string UPDATE_JOB_DATA = "UPDATE " ~ TABLE_PREFIX_SUBST
    ...
    enum string SELECT_NUM_JOBS = "SELECT COUNT(" ~ COL_JOB_NAME
            ~ ") " ~ " FROM " ~ TABLE_PREFIX_SUBST ~ TABLE_JOB_DETAILS ~ " WHERE "
            ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    ...
    enum string SELECT_JOBS_IN_GROUP_LIKE = "SELECT " ~ COL_JOB_NAME ~ ", " ~ COL_JOB_GROUP
            ~ " FROM " ~ TABLE_PREFIX_SUBST ~ TABLE_JOB_DETAILS ~ " WHERE "
            ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
            ~ " AND " ~ COL_JOB_GROUP ~ " LIKE ?";

    enum string SELECT_JOBS_IN_GROUP = "SELECT " ~ COL_JOB_NAME ~ ", " ~ COL_JOB_GROUP
            ~ " FROM " ~ TABLE_PREFIX_SUBST ~ TABLE_JOB_DETAILS ~ " WHERE "
            ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
            ~ " AND " ~ COL_JOB_GROUP ~ " = ?";
    ...
    enum string UPDATE_TRIGGER_SKIP_DATA = "UPDATE " ~ TABLE_PREFIX_SUBST
    ...
    enum string UPDATE_TRIGGER = "UPDATE " ~ TABLE_PREFIX_SUBST
        ~ TABLE_TRIGGERS ~ " SET " ~ COL_JOB_NAME ~ " = ?, "
        ~ COL_JOB_GROUP ~ " = ?, "
        ~ COL_DESCRIPTION ~ " = ?, " ~ COL_NEXT_FIRE_TIME ~ " = ?, "
        ~ COL_PREV_FIRE_TIME ~ " = ?, " ~ COL_TRIGGER_STATE ~ " = ?, "
    ...
    enum string UPDATE_CALENDAR = "UPDATE " ~ TABLE_PREFIX_SUBST
    ...
    enum string SELECT_CALENDARS = "SELECT " ~ COL_CALENDAR_NAME
    ...
    enum string DELETE_ALL_SIMPLE_TRIGGERS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "SIMPLE_TRIGGERS " ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_SIMPROP_TRIGGERS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "SIMPROP_TRIGGERS " ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_CRON_TRIGGERS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "CRON_TRIGGERS" ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_BLOB_TRIGGERS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "BLOB_TRIGGERS" ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_TRIGGERS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "TRIGGERS" ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_JOB_DETAILS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "JOB_DETAILS" ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_CALENDARS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "CALENDARS" ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
    enum string DELETE_ALL_PAUSED_TRIGGER_GRPS = "DELETE FROM " ~ TABLE_PREFIX_SUBST ~ "PAUSED_TRIGGER_GRPS" ~ " WHERE " ~ COL_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
