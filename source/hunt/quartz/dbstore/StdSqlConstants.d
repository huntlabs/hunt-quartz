...
//         ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE "
//         ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//         ~ " AND NOT ("
//         ~ ModelConstants.FIELD_MISFIRE_INSTRUCTION ~ " = " ~ Trigger.MISFIRE_INSTRUCTION_IGNORE_MISFIRE_POLICY ~ ") AND " 
...
//             ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST ~ " AND "
//             ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ?";
...
//         ~ ModelConstants.FIELD_MISFIRE_INSTRUCTION ~ " = " ~ Trigger.MISFIRE_INSTRUCTION_IGNORE_MISFIRE_POLICY ~ ") AND " 
//         ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " < ? AND " ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ? "
//         ~ "ORDER BY " ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " ASC, " ~ ModelConstants.FIELD_PRIORITY ~ " DESC";
...
//         ~ ModelConstants.FIELD_MISFIRE_INSTRUCTION ~ " = " ~ Trigger.MISFIRE_INSTRUCTION_IGNORE_MISFIRE_POLICY ~ ") AND " 
//         ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " < ? " 
//         ~ "AND " ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ?";
...
//             ~ ModelConstants.FIELD_IS_NONCONCURRENT ~ " = ?, " ~ ModelConstants.FIELD_IS_UPDATE_DATA ~ " = ?, " 
//             ~ ModelConstants.FIELD_REQUESTS_RECOVERY ~ " = ?, "
//             ~ ModelConstants.FIELD_JOB_DATAMAP ~ " = ? " ~ " WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME
//             ~ " = ? AND " ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?";

//     enum string SELECT_TRIGGERS_FOR_JOB = "SELECT "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " FROM "
//             ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME
...
//     enum string SELECT_TRIGGERS_FOR_CALENDAR = "SELECT "
//         ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " FROM "
//         ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " 
//         ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
//         ~ " AND " ~ ModelConstants.FIELD_CALENDAR_NAME
//         ~ " = ?";

//     enum string DELETE_JOB_DETAIL = "DELETE FROM "
//             ~ ModelConstants.MODEL_JOB_DETAILS ~ " WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME
//             ~ " = ? AND " ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?";

//     enum string SELECT_JOB_NONCONCURRENT = "SELECT "
//             ~ ModelConstants.FIELD_IS_NONCONCURRENT ~ " FROM " ~ ModelConstants.MODEL_JOB_DETAILS ~ " WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME
//             ~ " = ? AND " ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?";

//     enum string SELECT_JOB_EXISTENCE = "SELECT " ~ ModelConstants.FIELD_JOB_NAME
//             ~ " FROM " ~ ModelConstants.MODEL_JOB_DETAILS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST 
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME
//             ~ " = ? AND " ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?";
...
//             ~ ModelConstants.FIELD_JOB_GROUP ~ ") FROM " ~ ModelConstants.MODEL_JOB_DETAILS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;

//     enum string SELECT_JOBS_IN_GROUP_LIKE = "SELECT " ~ ModelConstants.FIELD_JOB_NAME ~ ", " ~ ModelConstants.FIELD_JOB_GROUP
//             ~ " FROM " ~ ModelConstants.MODEL_JOB_DETAILS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_JOB_GROUP ~ " LIKE ?";
...
//             ~ ModelConstants.MODEL_TRIGGERS ~ " (" ~ ModelConstants.FIELD_SCHEDULER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_NAME
//             ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ ", " ~ ModelConstants.FIELD_JOB_NAME ~ ", "
//             ~ ModelConstants.FIELD_JOB_GROUP ~ ", " ~ ModelConstants.FIELD_DESCRIPTION
//             ~ ", " ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ ", " ~ ModelConstants.FIELD_PREV_FIRE_TIME ~ ", "
//             ~ ModelConstants.FIELD_TRIGGER_STATE ~ ", " ~ ModelConstants.FIELD_TRIGGER_TYPE ~ ", "
//             ~ ModelConstants.FIELD_START_TIME ~ ", " ~ ModelConstants.FIELD_END_TIME ~ ", " ~ ModelConstants.FIELD_CALENDAR_NAME
//             ~ ", " ~ ModelConstants.FIELD_MISFIRE_INSTRUCTION ~ ", " ~ ModelConstants.FIELD_JOB_DATAMAP ~ ", " ~ ModelConstants.FIELD_PRIORITY ~ ") "
//             ~ " VALUES(" ~ SCHED_NAME_SUBST ~ ", ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

//     enum string INSERT_SIMPLE_TRIGGER = "INSERT INTO "
//             ~ ModelConstants.MODEL_SIMPLE_TRIGGERS ~ " ("
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ ", "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ ", "
//             ~ ModelConstants.FIELD_REPEAT_COUNT ~ ", " ~ ModelConstants.FIELD_REPEAT_INTERVAL ~ ", "
//             ~ ModelConstants.FIELD_TIMES_TRIGGERED ~ ") " ~ " VALUES(" ~ SCHED_NAME_SUBST ~ ", ?, ?, ?, ?, ?)";

//     enum string INSERT_CRON_TRIGGER = "INSERT INTO "
//             ~ ModelConstants.MODEL_CRON_TRIGGERS ~ " ("
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ ", "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ ", "
...
//             ~ ModelConstants.MODEL_BLOB_TRIGGERS ~ " ("
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ ", "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ ", " ~ ModelConstants.FIELD_BLOB
//             ~ ") " ~ " VALUES(" ~ SCHED_NAME_SUBST ~ ", ?, ?, ?)";
...
//             ~ " = ? WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME
...
//         ~ ModelConstants.FIELD_JOB_DATAMAP ~ " = ? WHERE " 
//         ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//         ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";
    
//     enum string UPDATE_SIMPLE_TRIGGER = "UPDATE "
//             ~ ModelConstants.MODEL_SIMPLE_TRIGGERS ~ " SET "
//             ~ ModelConstants.FIELD_REPEAT_COUNT ~ " = ?, " ~ ModelConstants.FIELD_REPEAT_INTERVAL ~ " = ?, "
//             ~ ModelConstants.FIELD_TIMES_TRIGGERED ~ " = ? WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME
//             ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";
...
//             ~ " = ? WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND "
//             ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";

//     enum string SELECT_TRIGGER_EXISTENCE = "SELECT "
...
//             ~ " = ?" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND "
//             ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ?";
...
//             ~ ModelConstants.MODEL_TRIGGERS ~ " SET " ~ ModelConstants.FIELD_TRIGGER_STATE
//             ~ " = ? WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME ~ " = ? AND " ~ ModelConstants.FIELD_JOB_GROUP
//             ~ " = ?";
...
//             ~ ModelConstants.MODEL_SIMPLE_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";

//     enum string DELETE_CRON_TRIGGER = "DELETE FROM "
//             ~ ModelConstants.MODEL_CRON_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";

//     enum string DELETE_BLOB_TRIGGER = "DELETE FROM "
//             ~ ModelConstants.MODEL_BLOB_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";
...
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ") FROM " ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME ~ " = ? AND "
//             ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?";
...
//             ~ ModelConstants.FIELD_TRIGGER_STATE ~ " FROM " ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND "
//             ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";

//     enum string SELECT_TRIGGER_STATUS = "SELECT "
//             ~ ModelConstants.FIELD_TRIGGER_STATE ~ ", " ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ ", "
//             ~ ModelConstants.FIELD_JOB_NAME ~ ", " ~ ModelConstants.FIELD_JOB_GROUP ~ " FROM "
//             ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";
...
//             ~ ModelConstants.FIELD_TRIGGER_GROUP ~ ") FROM " ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;

//     enum string SELECT_TRIGGER_GROUPS_FILTERED = "SELECT DISTINCT("
//             ~ ModelConstants.FIELD_TRIGGER_GROUP ~ ") FROM " ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST ~ " AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " LIKE ?";

//     enum string SELECT_TRIGGERS_IN_GROUP_LIKE = "SELECT "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " FROM " ~ ModelConstants.MODEL_TRIGGERS
//             ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " LIKE ?";

//     enum string SELECT_TRIGGERS_IN_GROUP = "SELECT "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " FROM " ~ ModelConstants.MODEL_TRIGGERS
//             ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";

//     enum string INSERT_CALENDAR = "INSERT INTO "
//             ~ ModelConstants.MODEL_CALENDARS ~ " (" ~ ModelConstants.FIELD_SCHEDULER_NAME ~ ", " ~ ModelConstants.FIELD_CALENDAR_NAME
//             ~ ", " ~ ModelConstants.FIELD_CALENDAR ~ ") " ~ " VALUES(" ~ SCHED_NAME_SUBST ~ ", ?, ?)";

//     enum string UPDATE_CALENDAR = "UPDATE " ~ ModelConstants.MODEL_CALENDARS ~ " SET " ~ ModelConstants.FIELD_CALENDAR ~ " = ? " ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_CALENDAR_NAME ~ " = ?";

//     enum string SELECT_CALENDAR_EXISTENCE = "SELECT "
//             ~ ModelConstants.FIELD_CALENDAR_NAME ~ " FROM " ~ ModelConstants.MODEL_CALENDARS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_CALENDAR_NAME ~ " = ?";

//     enum string SELECT_CALENDAR = "SELECT *" ~ " FROM "
//             ~ ModelConstants.MODEL_CALENDARS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_CALENDAR_NAME ~ " = ?";

//     enum string SELECT_REFERENCED_CALENDAR = "SELECT "
//             ~ ModelConstants.FIELD_CALENDAR_NAME ~ " FROM " ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_CALENDAR_NAME ~ " = ?";
...
//             ~ " FROM " ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ? AND " ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " >= 0";

//     enum string SELECT_TRIGGER_FOR_FIRE_TIME = "SELECT "
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ", " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " FROM "
//             ~ ModelConstants.MODEL_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ? AND " ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " = ?";
...
//         ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//         ~ " AND " ~ ModelConstants.FIELD_TRIGGER_STATE ~ " = ? AND " ~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " <= ? " 
//         ~ "AND (" ~ ModelConstants.FIELD_MISFIRE_INSTRUCTION ~ " = -1 OR (" ~ModelConstants.FIELD_MISFIRE_INSTRUCTION~ " != -1 AND "~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " >= ?)) "
//         ~ "ORDER BY "~ ModelConstants.FIELD_NEXT_FIRE_TIME ~ " ASC, " ~ ModelConstants.FIELD_PRIORITY ~ " DESC";
...
//             ~ ModelConstants.FIELD_FIRED_TIME ~ ", " ~ ModelConstants.FIELD_SCHED_TIME ~ ", " ~ ModelConstants.FIELD_ENTRY_STATE ~ ", " ~ ModelConstants.FIELD_JOB_NAME
...
//         ~ ModelConstants.FIELD_FIRED_TIME ~ " = ?, " ~ ModelConstants.FIELD_SCHED_TIME ~ " = ?, " ~ ModelConstants.FIELD_ENTRY_STATE ~ " = ?, " ~ ModelConstants.FIELD_JOB_NAME
//         ~ " = ?, " ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?, " ~ ModelConstants.FIELD_IS_NONCONCURRENT ~ " = ?, "
//         ~ ModelConstants.FIELD_REQUESTS_RECOVERY ~ " = ? WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//         ~ " AND " ~ ModelConstants.FIELD_ENTRY_ID ~ " = ?";

//     enum string SELECT_INSTANCES_FIRED_TRIGGERS = "SELECT * FROM "
//             ~ ModelConstants.MODEL_FIRED_TRIGGERS
//             ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_INSTANCE_NAME ~ " = ?";

//     enum string SELECT_INSTANCES_RECOVERABLE_FIRED_TRIGGERS = "SELECT * FROM "
//             ~ ModelConstants.MODEL_FIRED_TRIGGERS
//             ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_INSTANCE_NAME ~ " = ? AND " ~ ModelConstants.FIELD_REQUESTS_RECOVERY ~ " = ?";

//     enum string SELECT_JOB_EXECUTION_COUNT = "SELECT COUNT("
//             ~ ModelConstants.FIELD_TRIGGER_NAME ~ ") FROM " ~ ModelConstants.MODEL_FIRED_TRIGGERS ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_JOB_NAME ~ " = ? AND "
//             ~ ModelConstants.FIELD_JOB_GROUP ~ " = ?";
...
//             ~ ModelConstants.MODEL_FIRED_TRIGGERS ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_NAME ~ " = ? AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";
...
//             ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_INSTANCE_NAME ~ " = ?" ~ ModelConstants.FIELD_REQUESTS_RECOVERY ~ " = ?";

//     enum string DELETE_ALL_SIMPLE_TRIGGERS = "DELETE FROM " ~ "SIMPLE_TRIGGERS " ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_SIMPROP_TRIGGERS = "DELETE FROM " ~ "SIMPROP_TRIGGERS " ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_CRON_TRIGGERS = "DELETE FROM " ~ "CRON_TRIGGERS" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_BLOB_TRIGGERS = "DELETE FROM " ~ "BLOB_TRIGGERS" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_TRIGGERS = "DELETE FROM " ~ "TRIGGERS" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_JOB_DETAILS = "DELETE FROM " ~ "JOB_DETAILS" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_CALENDARS = "DELETE FROM " ~ "CALENDARS" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
//     enum string DELETE_ALL_PAUSED_TRIGGER_GRPS = "DELETE FROM " ~ "PAUSED_TRIGGER_GRPS" ~ " WHERE " ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST;
...
//             ~ ModelConstants.MODEL_SCHEDULER_STATE ~ " WHERE "
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_INSTANCE_NAME ~ " = ?";
...
//         ~ ModelConstants.FIELD_LAST_CHECKIN_TIME ~ " = ? WHERE "
//         ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//         ~ " AND " ~ ModelConstants.FIELD_INSTANCE_NAME ~ " = ?";
...
//     enum string SELECT_PAUSED_TRIGGER_GROUP = "SELECT "
//             ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " FROM " ~ ModelConstants.MODEL_PAUSED_TRIGGERS ~ " WHERE " 
//             ~ ModelConstants.FIELD_SCHEDULER_NAME ~ " = " ~ SCHED_NAME_SUBST
//             ~ " AND " ~ ModelConstants.FIELD_TRIGGER_GROUP ~ " = ?";
